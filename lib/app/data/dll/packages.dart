...
class Packages {
  static final dismissiblePage = PackagesModel('Dismissible Page',
      definisi:
  ...
  static final animatedTextKit = PackagesModel('Animated Text Kit',
      definisi:
  ...
  static final flutterAnimate = PackagesModel('Flutter Animate',
      definisi:
  ...
  static final borderedText = PackagesModel('Bordered Text',
      definisi:
  ...
  static final lottie = PackagesModel('Lottie',
      definisi:
  ...
  static final flutterStaggeredAnimations = PackagesModel(
  ...
  static final getx = PackagesModel('Get',
      definisi:
  ...
  static final urlStrategy = PackagesModel('URL Strategy',
      definisi:
  ...
  static final urlLauncher = PackagesModel('URL Launcher',
      definisi:
  ...
  static final provider = PackagesModel('Provider',
      definisi:
  ...
  static final pieChart = PackagesModel('Pie Chart',
      definisi:
  ...
  static final localStorage = PackagesModel('Local Storage',
      definisi:
  ...
  static final scrollToIndex = PackagesModel('Scroll To Index',
      definisi:
  ...
  static final translator = PackagesModel('Translator',
      definisi:
  ...
  static final imagePicker = PackagesModel('Image Picker',
      definisi:
  ...
  static final intl = PackagesModel('Intl',
      definisi:
  ...
  static final hive = PackagesModel('Hive',
      definisi:
  ...
  static final flutterLauncherIcons = PackagesModel('Flutter Launcher Icons',
      definisi:
  ...
  static final awesomeDialog = PackagesModel('Awesome Dialog',
      definisi:
  ...
  static final doubleBackToClose = PackagesModel('Double Back To Close',
      definisi:
  ...
  static final http = PackagesModel('HTTP',
      definisi:
  ...
  static final pageTransition = PackagesModel('Page Transition',
      definisi:
  ...
  static final teledart = PackagesModel('Teledart',
      definisi:
  ...
  static final firebaseCore = PackagesModel('Firebase Core',
      definisi:
  ...
  static final formValidator = PackagesModel('Form Validator',
      definisi:
  ...
  static final firebaseAuth = PackagesModel('Firebase Auth',
      definisi:
  ...
  static final cloudFirestore = PackagesModel('Cloud Firestore',
      definisi:
  ...
  static final firebaseStorage = PackagesModel('Firebase Storage',
      definisi:
  ...
  static final flutterLocalNotifications = PackagesModel(
  ...
  static final animatedSizeAndFade = PackagesModel('Animated Size and Fade',
      definisi:
  ...
  static final carouselslider = PackagesModel('Carousel Slider',
      definisi:
  ...
  static final universalHTML = PackagesModel('Universal HTML',
      definisi:
  ...
  static final audioplayers = PackagesModel('Audioplayers',
      definisi:
  ...
  static final searchPage = PackagesModel('Search Page',
      definisi:
  ...
  static final videoPlayer = PackagesModel('Video Player',
      definisi:
  ...
  static final badges = PackagesModel('Badges',
      definisi:
  ...
  static final dayNightSwitcher = PackagesModel('Day Night Switcher',
      definisi:
  ...
  static final deviceInfoPlus = PackagesModel('Device Info Plus',
      definisi:
  ...
  static final flutterRatingBar = PackagesModel('Flutter Rating Bar',
      definisi:
  ...
  static final dropdownSearch = PackagesModel('Dropdown Search',
      definisi:
  ...
  static final flutterOnboardingSlider = PackagesModel(
  ...
  static final autoSizeText = PackagesModel('Auto Size Text',
      definisi:
  ...
  static final googleFonts = PackagesModel('Google Fonts',
      definisi:
  ...
  static final hiveFlutter = PackagesModel('Hive Flutter',
      definisi:
  ...
  static final waveTransition = PackagesModel('Wave Transition',
      definisi:
  ...
  static final flutterAppName = PackagesModel('Flutter App Name',
      definisi:
  ...
  static final hiveGenerator = PackagesModel('Hive Generator',
      definisi:
  ...
  static final buildRunner = PackagesModel('Build Runner',
      definisi:
  ...
  static final webViewFlutter = PackagesModel('Webview Flutter',
      definisi:
